...
[![Go Report Card](https://goreportcard.com/badge/github.com/kunalsin9h/cf-tool)](https://goreportcard.com/report/github.com/kunalsin9h/cf-tool)
[![Go Version](https://img.shields.io/badge/go-%3E%3D1.12-green.svg)](https://github.com/golang)
[![license](https://img.shields.io/badge/license-MIT-%23373737.svg)](https://raw.githubusercontent.com/kunalsin9h/cf-tool/master/LICENSE)
...
You can download the pre-compiled binary file in [here](https://github.com/kunalsin9h/cf-tool/releases).
...
```plain
$ go get github.com/kunalsin9h/cf-tool
$ cd $GOPATH/src/github.com/kunalsin9h/cf-tool
 ...
 * You can download the binary file in here https://github.com/kunalsin9h/cf-tool (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
